...
- `scripts/mochi_unpack.py` / `mochi_pack.py` / `mochi_edit.py` — flashcard primitives. Pull only when actually editing cards; the calling convention is documented in `docs/RULES.md` → Mochi edit workflow.
